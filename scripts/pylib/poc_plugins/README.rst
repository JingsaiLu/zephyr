...
.. code-block:: yaml
   ...
   map.yml:
     - connected: true
       fixtures:
         - multi_instance_harness: /path/to/your/harness_boards_for_one_dut.yml
       id: 001061256778
...
==================
    ...
    such as, flash different build dirs for harness devices,
...
which should return the build_dirs for each harness devices.
